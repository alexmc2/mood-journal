...
export default function ChatComponent({
  ...
  return (
    <div className="overflow-y-hidden h-full ">
      ...
      <div className="input w-full flex flex-col justify-between h-full bg-white dark:bg-blue-800 text-slate-700 dark:text-slate-300   ">
        {/* Messages display */}
        <ScrollableFeed
        ...
        <div className="chat-input-container relative xl:w-[50%] w-[100%]  sm:max-w-[900px] max-w-[1200px] mx-auto mt-auto md:pb-6 pb-4">
