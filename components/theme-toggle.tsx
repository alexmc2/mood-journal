...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label className="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-200 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full" htmlFor="light-switch">
